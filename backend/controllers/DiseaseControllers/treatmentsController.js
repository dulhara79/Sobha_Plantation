...
const TreatmentRecords = require("../../models/DiseaseModels/treatmentsModel");
...
const newRecord = new TreatmentRecords({
    dateOfTreatment,
    pestOrDisease,
    treatmentMethod,
    healthRate,
...
exports.getAllTreatments = async (req, res) => {
    try {
        const allTreatmentRecords = await TreatmentRecords.find();
...
exports.getTreatmentsById = async (req, res) => {
    try {
        ...
        const treatmentRecord = await TreatmentRecords.findById(treatmentId);
...
exports.updateTreatments = async (req, res) => {
        try {
            ...
            const updatedTreatmentRecord = await TreatmentRecords.findByIdAndUpdate(treatmentId,
...
exports.deleteTreatments = async (req, res) => {
    try {
        ...
        const deletedTreatmentRecord = await TreatmentRecords.findByIdAndDelete(treatmentId);
