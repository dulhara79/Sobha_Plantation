...
const Menu = ({ className = "", customerIcons }) => {
  return (
    <div
      className={`w-[306px] shadow-[0px_4px_8px_3px_rgba(0,_0,_0,_0.25)] rounded-tl-none rounded-tr-31xl rounded-br-31xl rounded-bl-none bg-whitesmoke flex flex-col items-start justify-start pt-[88px] px-2 pb-[240.3px] box-border relative gap-[39.7px] text-left text-9xl text-gray-1700 font-roboto mq450:gap-5 mq750:pt-[37px] mq750:pb-[101px] mq750:box-border mq1050:hidden mq1050:pt-[57px] mq1050:pb-[156px] mq1050:box-border ${className}`}
    >
      ...
      <div className="w-[279px] flex flex-col items-start justify-start gap-[21px]">
        ...
        <div className="self-stretch shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] rounded-31xl bg-limegreen flex flex-row items-start justify-start py-[11px] px-[29px] gap-[48.2px] z-[1] text-black mq450:gap-6">
          ...
          <img
            ...
            src="/vector-11.svg"
          />
          <b className="relative inline-block min-w-[114px] z-[1] mq450:text-3xl">
            Finances
          </b>
        </div>
            ...
            <div className="w-[138px] flex flex-col items-start justify-start gap-[35.8px]">
              <div className="self-stretch flex flex-col items-start justify-start gap-[41px]">
                <div className="flex flex-row items-start justify-start px-px py-0">
                  <b className="relative inline-block min-w-[124px] z-[1] mq450:text-3xl">
                    Inventory
                  </b>
                </div>
                <b className="h-11 relative inline-block text-center shrink-0 z-[1] mq450:text-3xl">
                  Employees
                </b>
              </div>
              <div className="flex flex-row items-start justify-start px-px py-0">
          ...
          <div className="w-[131px] flex flex-col items-start justify-start gap-[48.2px]">
            ...
            <div className="self-stretch flex flex-col items-start justify-start gap-[42.5px]">
              <div className="self-stretch flex flex-row items-start justify-start py-0 pl-px pr-[5px]">
                <b className="flex-1 relative z-[1] mq450:text-3xl">Products</b>
              </div>
              ...
              <div className="w-[100px] flex flex-row items-start justify-start py-0 px-px box-border">
                <b className="flex-1 relative z-[1] mq450:text-3xl">Buyers</b>
              </div>
            </div>
          </div>
        </div>
...
Menu.propTypes = {
  ...
  customerIcons: PropTypes.string,
};
