...
//       console.log('yearlySalesRes:', yearlySalesRes.data);
//       console.log('productPerfRes:', productPerfRes.data);      
...
const FinancialAnalytics = () => {
  ...
  const fetchAnalyticsData = async () => {
    try {
      // const [monthlyRes, yearlySalesRes, productPerfRes] = await Promise.all([
      //   axios.get('/api/salesAndFinance/finance/analytics/monthly-analytics'),
      //   axios.get('/api/salesAndFinance/finance/analytics/yearly-sales'),
      //   axios.get('/api/salesAndFinance/finance/analytics/product-performance'),
      // ]);

      const monthlyRes = await axios.get('/api/salesAndFinance/finance/analytics/monthly-analytics');
      const yearlySalesRes = await axios.get('/api/salesAndFinance/finance/analytics/yearly-sales');
      const productPerfRes = await axios.get('/api/salesAndFinance/finance/analytics/product-performance');
      ...
      console.log('productPerfRes.data:', typeof productPerfRes.data);
  ...
  return (
    <div className="financial-analytics-page">
      <Row gutter={16}>
        ...
        <Col span={24}>
          <Card title="Weekly Product Performance Analytics">
            <ResponsiveContainer width="100%" height={400}>
              <PieChart>
                <Pie
                  data={productPerformance}
