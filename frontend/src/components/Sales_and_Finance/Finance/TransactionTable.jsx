...
import { Table, Card, DatePicker, Select, Input, Button, Popconfirm, Tooltip } from 'antd';
...
const TransactionTable = () => {
  ...
  const exportToPDF = () => {
    ...
    autoTable(doc, {
      head: [['Date', 'Type', 'Sub Type', 'Description', 'Payer/Payee', 'Method', 'Amount']],
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`http://localhost:5000/api/salesAndFinance/finance/transaction/${id}`);
      ...
      <Card>
        <div className="mb-4">
          ...
          <Input
            ...
            style={{ width: 300 }}
          />
          <Button onClick={() => applyFilters(transactions)} type="primary" className="ml-4">Apply Filters</Button>
          ...
          <Button onClick={exportToPDF} type="default" className="ml-4">Export to PDF</Button>
        </div>
