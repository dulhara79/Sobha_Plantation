...
const menuItems = [
    { name: "HOME", path:"/cultivationDashboard"  },
    { name: "CROP VARIETY", path: "/varietyCrop" },
    { name: "LAND PREPARE", path: "/landPreparation" },
    { name: "SEEDLING", path: "/seedlingDistribution" },
    { name: "SCHEDULE", path: "/schedules" },
    { name: "PLANT GROWTH", path: "/pGrowth" },
