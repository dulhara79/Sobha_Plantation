...
const BuyerHeader = ({
  ...
  return (
    <header
      className={`h-[70px] self-stretch shadow-[0px_2px_4px_rgba(0,_0,_0,_0.25)] bg-white flex items-center justify-between px-5 box-border z-[99] sticky top-0 max-w-full ${className}`}
      style={HeaderStyle}
    >
      {/* Profile Icon Section (Left) */}
