...
import { HomeOutlined, LeftOutlined, FilePdfOutlined, DownOutlined, SearchOutlined, EditOutlined, DeleteOutlined } from '@ant-design/icons';
      ...
      <div className='flex h-screen'>
        ...
        <div className="flex-1 ml-[300px] p-4 overflow-auto">
          ...
          <div className="mt-4 px-6">
            ...
            {/* Table */}
            <div className="mt-4">
              <Table dataSource={filteredTreatments} columns={columns} pagination={{ pageSize: 5 }} />
            </div>
