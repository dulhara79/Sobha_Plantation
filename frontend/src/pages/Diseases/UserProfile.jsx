  ...
  return (
    <div>
      ...
      <div className="ml-[300px] p-4">
        ...
        {/* Profile Section */}
<div className="mt-8">
  <h1 className="text-8xl text-center font-semibold mb-8">User Profile</h1>
  ...
  <div className="flex flex-col items-center justify-center">
    ...
    <div className="bg-[#3CCD65] rounded-3xl shadow-lg p-10 flex flex-col items-center relative w-3/4 max-w-4xl mt-12 h-[450px]">
      ...
      <div className="mt-20 text-xl font-bold text-center w-full">
        <h3 className="text-10xl font-bold mb-4 text-white">Dewdu Sendanayake</h3>
        <ul className="text-black space-y-2 list-none">
          <li>Date of Birth: <span className="font-medium text-xl">31/08/2001</span></li>
          <li>Gender: <span className="font-medium text-xl">Female</span></li>
          <li>Email: <span className="font-medium text-xl">hdsendanayake@gmail.com</span></li>
          <li>Contact Number: <span className="font-medium text-xl">0707081326</span></li>
          <li>Address: <span className="font-medium text-xl">54/21, Villuda Uyana, Panagoda, Homagama</span></li>
        </ul>
    ...
    <div className="flex space-x-10 mt-8 mb-8">
      <Button type="default" className="bg-[#3CCD65] text-white hover:bg-[#2b8f57] rounded-full px-15 py-5 shadow-md">
        Update Profile
      </Button>
      <Button type="default" className="bg-[#3CCD65] text-white hover:bg-[#2b8f57] rounded-full px-15 py-5 shadow-md">
        Delete Profile
