...
const CoconutMite = () => {
  ...
  const generatePDF = () => {
    ...
    doc.setFontSize(22);
    doc.setTextColor(40);
    doc.text("Coconut Mite", 105, 20, null, null, "center");

    // Include image
    const imgData = CoconutMiteImage;
    ...
    doc.setTextColor(80);
    doc.text(
      `- Presence of fine stippling or mottling on leaves.
- Yellowing and curling of leaves.
- Reduced plant growth and vigor.
- Possible leaf drop in severe cases.`,
      20,
      200,
    ...
    doc.setFont("helvetica", "normal");
    doc.text(
      `- Regular monitoring and use of miticides.
- Application of neem oil or other natural pesticides.
- Maintaining plant health through proper nutrition and watering.
- Using predatory mites to control pest populations.`,
      20,
      240,
      { maxWidth: 170, align: "left" }
    );
        ...
        <div className="mt-4">
          ...
          <div className="mt-10">
            ...
            <p className="mt-2 text-lg">
              The Coconut Mite is a tiny pest that affects coconut palms,
              causing a range of damage including leaf stippling and reduced
              overall plant vigor. These mites feed on the plant's sap, leading
              to chlorosis and poor growth.
            </p>
          </div>
